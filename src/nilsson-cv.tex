...
\maketitle
\section{Education}
\cventry{2009-2014 (expected)}{BSc and MSc in Computer Science (theoretical track), KTH}{Stockholm, Sweden}{}{}{}
...
\section{Knowledge} 
  ...
  \cvline{Architectures}{X86, AVR, FPGA, GPU (CUDA)}
...
\section{Selection of Projects} 
  ...
  \\
  \\
  \cventry{non-public}{Distributed approach to BTC markets}{Own project}{\textasciitilde 2k LOC}{}{
    Project written in Haskell with focus on retrieving bitcoin (digital currency) market feeds in a reliable and scalable way.
    Build up around a ``proxy layer'' which consists of public-facing nodes pooled together.
    ...
    These are requested periodically from the backend and the results are stored in a distributed database (currently Cassandra).
    The project basically provides a pool of IP addresses and circumvents regional issues such as connectivity problems, but also adds scaling by integrating new proxy nodes while running.
  }
  \\
  \\
  ...
  \\
  \\
  \cventry{non-public}{Library of algorithms}{Course project}{\textasciitilde 6k LOC}{}{
    As part of the course \emph{problem solving and programming under pressure (popup)} I implemented a library in C++11 containing a wide range of algorithms.
    There are four main categories: string algorithms, graph theory, number theory, and computational geometry.
    The project was bencifical in getting working knowledge of C++ (and the new standard), but also in writing testable and correct code.
  }
  \\
  \\
